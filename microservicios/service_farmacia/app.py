"""
app.py — Microservicio de Farmacia (Flask). Puerto por defecto 5003 (FARMACIA_URL o PORT).

    GET  /health        estado del servicio y del modelo
    GET  /kpis          indicadores operativos de farmacia (demanda real, stock simulado)
    POST /predict       {"fecha": "YYYY-MM-DD" (opcional), "codigo": "..." | "tipo_item": "Medicamento"|"Insumo / dispositivo" (opcionales)}
    GET  /reporte.xlsx  reporte de tres hojas

Ejecución directa: python microservicios/service_farmacia/app.py
"""
...
from model import PUERTO_POR_DEFECTO, SERVICIO, VAR_URL, ModeloFarmacia  # noqa: E402
...
dominio = ModeloFarmacia(DB_PATH)
app = Flask(__name__)
