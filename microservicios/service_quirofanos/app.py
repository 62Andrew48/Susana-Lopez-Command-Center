"""
app.py — Microservicio de Quirófanos (Flask). Puerto por defecto 5002 (QUIROFANOS_URL o PORT).

    GET  /health        estado del servicio y del modelo
    GET  /kpis          indicadores operativos de quirófanos
    POST /predict       {"fecha": "YYYY-MM-DD" (opcional), "area_quirofano": "..." (opcional)}
    GET  /reporte.xlsx  reporte de tres hojas

Ejecución directa: python microservicios/service_quirofanos/app.py
"""
...
from model import PUERTO_POR_DEFECTO, SERVICIO, VAR_URL, ModeloQuirofanos  # noqa: E402
...
dominio = ModeloQuirofanos(DB_PATH)
app = Flask(__name__)
