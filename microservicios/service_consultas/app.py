"""
app.py — Microservicio de Consultas ambulatorias (Flask). Puerto por defecto 5004 (CONSULTAS_URL o PORT).

    GET  /health        estado del servicio y del modelo
    GET  /kpis          indicadores de ingresos ambulatorios y servicios por especialidad
    POST /predict       {"fecha": "YYYY-MM-DD" (opcional), "especialidad": "..." (opcional), "incluir_urgencias": bool (opcional)}
    GET  /reporte.xlsx  reporte de tres hojas

Ejecución directa: python microservicios/service_consultas/app.py
"""
...
from model import PUERTO_POR_DEFECTO, SERVICIO, VAR_URL, ModeloConsultas  # noqa: E402
...
dominio = ModeloConsultas(DB_PATH)
app = Flask(__name__)
